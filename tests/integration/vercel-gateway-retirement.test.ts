...
describe("Vercel AI Gateway retirement", { timeout: 30_000 }, () => {
  ...
  const VENDOR_PRICES: Record<string, string> = {
    "deepseek-v4-flash-tokens-input": "0.0000560000",
    "deepseek-v4-flash-tokens-output": "0.0001120000",
    "deepseek-v4-pro-tokens-input": "0.0001740000",
    "deepseek-v4-pro-tokens-output": "0.0003480000",
  };
  ...
  it("serves the six Moonshot Kimi names at the vendor basis after boot", async () => {
    ...
    const expected: Record<string, string> = {
      "moonshot-kimi-k2.6-tokens-input": "0.0003800000", // $0.95/MTok × 4
      "moonshot-kimi-k2.6-tokens-cached-input": "0.0000640000", // $0.16/MTok × 4
      "moonshot-kimi-k2.6-tokens-output": "0.0016000000", // $4.00/MTok × 4
      "moonshot-kimi-k3-tokens-input": "0.0012000000", // $3.00/MTok × 4
      "moonshot-kimi-k3-tokens-cached-input": "0.0001200000", // $0.30/MTok × 4
      "moonshot-kimi-k3-tokens-output": "0.0060000000", // $15.00/MTok × 4
    };
