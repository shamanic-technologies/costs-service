...
| `featured-api-pitch-submit` | 0.1 | call | API call (pitch submit) | featured | featured.com | pay-as-you-go | monthly |
...
| `instantly-account-email-sent` | 3.2740740740 | email | Email send (per account) | instantly | instantly.ai | growth | monthly |
| `instantly-domain-email-sent` | 0.0793650794 | email | Email send (per domain) | instantly | instantly.ai | growth | yearly |
| `instantly-contact-uploaded` | 0.776 | contact | Contact upload | instantly | instantly.ai | hypergrowth | monthly |
| `instantly-account-email-sent` | 3.2740740740 | email | Email send (per account) | instantly | instantly.ai | hypergrowth | monthly |
| `instantly-domain-email-sent` | 0.0793650794 | email | Email send (per domain) | instantly | instantly.ai | hypergrowth | monthly |
